...
ESC=23
ESC2 = 21  #Connect the ESC in this GPIO pin
...
def calibrate():   #This is the auto calibration procedure of a normal ESC
    ...
    if inp == '':
        ...
        if inp == '':
            ...
            time.sleep(1)
            print("See.... uhhhhh")
            time.sleep(5) # You can change this to any other function you want
            stop()
def control():
...
def stopstop(): #This will stop every action your Pi is performing for ESC ofcourse.
    pi.set_servo_pulsewidth(ESC, 0)
    pi.set_servo_pulsewidth(ESC2, 0)
    pi.stop()
